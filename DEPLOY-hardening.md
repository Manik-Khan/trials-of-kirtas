...
| `smoke-settings-flyout.mjs` | repo root | +4 assertions: no color-mix in the sheet, every rule ID-armored, derived tones are rgba/rgb literals, the Sheet pointer on unwired pages |
