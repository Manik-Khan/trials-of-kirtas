/* Forge image structure-review authority.
   Pure semantic-region, surface, volume, and connector proposal helpers.
   Browser: window.ForgeImageStructureReview. Node: module.exports. */
(function (root, factory) {
  var importer = typeof module !== "undefined" && module.exports
    ? require("./forge-image-importer.js")
    : root.ForgeImageImporter;
  var api = factory(importer);
  if (typeof module !== "undefined" && module.exports) module.exports = api;
  else root.ForgeImageStructureReview = api;
