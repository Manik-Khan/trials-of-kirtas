/* Forge artwork interpreter · pure pixel analysis + Blueprint proposal.
   Browser: window.ForgeImageImporter. Node: module.exports.
   No image bytes leave the browser and no model or network service is used. */
(function (root, factory) {
  var api = factory();
  if (typeof module !== "undefined" && module.exports) module.exports = api;
  else root.ForgeImageImporter = api;
  ...
  function toBlueprint(analysis, options) {
    ...
    return {
      ...
      source: {
        ...
        review: findings,
        interpretation: {
          engine: "local-pixel-analysis/v1",
