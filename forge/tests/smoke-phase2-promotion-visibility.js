...
ok("Workshop navigation and planned panel replace disabled prototype controls",html.includes('data-workshop-nav="battlefield"')&&html.includes('data-workshop-nav="advanced"')&&html.includes('id="forgePlannedPanel"'));
...
ok("new derivation cache stamp is present",html.includes("forge-capabilities.js?v=fc4")&&html.includes("forge-capability-resolver.js?v=fcrs2")&&html.includes("forge-kit-derive.js?v=b20"));
