...
ok("new derivation cache stamp is present",html.includes("forge-capabilities.js?v=fc2")&&html.includes("forge-capability-resolver.js?v=fcrs1")&&html.includes("forge-kit-derive.js?v=b17"));
