...
has('forge-table-correctness.js?v=fd1','correctness seam is loaded');
...
has('ForgeTableCorrectness.pushEvent(r)','session feed paints authoritative resolved echoes');
