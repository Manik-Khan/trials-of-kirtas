...
ok("shared start consumes exact saved Temple positions",html.includes("savedDeployment&&[1,2].indexOf(Number(savedDeployment.version))>=0")&&html.includes("deployment has no exact position for"));
