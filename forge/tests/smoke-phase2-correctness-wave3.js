...
(async()=>{
  ...
  ok("cache stamps identify the wave-three runtime",html.includes("forge-replay.js?v=fb13")&&html.includes("forge-discovery.js?v=fd6")&&html.includes("forge-pipeline.js?v=fb7")&&html.includes("forge-board.js?v=fb7"));
