...
(async()=>{
  ...
  ok("cache stamps identify the wave-three runtime",html.includes("forge-replay.js?v=fb20")&&html.includes("forge-discovery.js?v=fd7")&&html.includes("forge-pipeline.js?v=fb9")&&html.includes("forge-board.js?v=fb11"));
