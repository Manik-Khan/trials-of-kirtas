...
(async()=>{
  ...
  ok("cache stamps identify the wave-three runtime",html.includes("forge-replay.js?v=fb10")&&html.includes("forge-discovery.js?v=fd3")&&html.includes("forge-pipeline.js?v=fb6")&&html.includes("forge-board.js?v=fb7"));
