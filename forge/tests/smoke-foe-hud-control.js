...
ok(html.includes('forge-foe-ai.js?v=fai3')&&html.includes('forge-hud.js?v=b6')&&html.includes('monster-actor.js?v=ma2'),'changed modules have fresh production cache stamps');
