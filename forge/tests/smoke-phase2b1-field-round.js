...
has(html,'forge-capabilities.js?v=fc1','shared capability contract cache stamp present');
has(html,'forge-kit-derive.js?v=b15','kit derivation cache stamp bumped');
