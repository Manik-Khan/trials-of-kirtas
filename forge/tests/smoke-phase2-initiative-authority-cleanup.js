...
ok("initiative scripts carry fresh cache stamps",html.includes('forge-initiative.js?v=fi2')&&html.includes('forge-capabilities.js?v=fc3')&&html.includes('forge-capability-resolver.js?v=fcrs1')&&html.includes('forge-kit-derive.js?v=b18'));
