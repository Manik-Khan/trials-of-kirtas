...
ok("cache stamps load every changed authority",html.includes("forge-replay.js?v=fb14")&&html.includes("forge-effects.js?v=fe5")&&html.includes("forge-discovery.js?v=fd7")&&html.includes("forge-pipeline.js?v=fb7")&&html.includes("forge-kit-derive.js?v=b10")&&html.includes("forge-table-correctness.js?v=fg8"));
