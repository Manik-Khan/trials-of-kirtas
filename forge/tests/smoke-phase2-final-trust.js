...
ok("cache stamps load every changed authority",html.includes("forge-replay.js?v=fb17")&&html.includes("forge-effects.js?v=fe6")&&html.includes("forge-discovery.js?v=fd7")&&html.includes("forge-pipeline.js?v=fb9")&&html.includes("forge-capabilities.js?v=fc1")&&html.includes("forge-kit-derive.js?v=b15")&&html.includes("forge-table-correctness.js?v=fg12"));
