...
ok("cache stamps load every changed authority",html.includes("forge-replay.js?v=fb13")&&html.includes("forge-effects.js?v=fe4")&&html.includes("forge-discovery.js?v=fd5")&&html.includes("forge-pipeline.js?v=fb7")&&html.includes("forge-kit-derive.js?v=b9")&&html.includes("forge-table-correctness.js?v=fg7"));
