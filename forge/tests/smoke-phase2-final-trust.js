...
ok("cache stamps load every changed authority",html.includes("forge-replay.js?v=fb20")&&html.includes("forge-effects.js?v=fe9")&&html.includes("forge-discovery.js?v=fd7")&&html.includes("forge-pipeline.js?v=fb9")&&html.includes("forge-board.js?v=fb11")&&html.includes("forge-capabilities.js?v=fc4")&&html.includes("forge-capability-resolver.js?v=fcrs2")&&html.includes("forge-kit-derive.js?v=b20")&&html.includes("forge-table-correctness.js?v=fg12"));
