...
ok(GF.GENERATOR_VERSION==="2.0.0-elevations.1","generator version marks true stage ownership");
...
ok(html.includes("forge-generator-foundation.js?v=g2e1")&&html.includes("forge-engine.js?v=fe5"),"stage-owned runtimes are cache-busted");
