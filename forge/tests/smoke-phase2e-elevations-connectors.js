...
fs.writeFileSync(path.join(forgeDir,"index.html"),topOld);
...
ok(patcher.inlineGeometry(fs.readFileSync(path.join(forgeDir,"index.html"),"utf8")).source===canonical,"patcher synchronizes production geometry exactly");
