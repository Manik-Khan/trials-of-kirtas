...
ok("cache stamps load the hardened replay, derivation, and presentation files",html.includes("forge-replay.js?v=fb17")&&html.includes("forge-capabilities.js?v=fc1")&&html.includes("forge-kit-derive.js?v=b15")&&html.includes("forge-table-correctness.js?v=fg12"));
