...
ok("player-view event copies strip defense fields while authoritative rows remain intact",html.includes("function redactEnemyDefenseEvent")&&html.includes("delete p.targetAC")&&html.includes("redactEnemyDefenseEvent(viewerFeedEvent(r))"));
  ok("cache stamps load the hardened replay, derivation, and presentation files",html.includes("forge-replay.js?v=fb20")&&html.includes("forge-capabilities.js?v=fc4")&&html.includes("forge-capability-resolver.js?v=fcrs2")&&html.includes("forge-kit-derive.js?v=b20")&&html.includes("forge-table-correctness.js?v=fg12"));
