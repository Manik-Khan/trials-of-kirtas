...
ok("cache stamps load the hardened replay, derivation, and presentation files",html.includes("forge-replay.js?v=fb18")&&html.includes("forge-capabilities.js?v=fc2")&&html.includes("forge-capability-resolver.js?v=fcrs1")&&html.includes("forge-kit-derive.js?v=b16")&&html.includes("forge-table-correctness.js?v=fg12"));
