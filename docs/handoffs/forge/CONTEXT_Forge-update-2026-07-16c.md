...
Supersedes `archive/context/forge/CONTEXT_Forge-update-2026-07-16b.md` as the
current concise Forge authority.

Read this with:

1. `CONTEXT.md`
2. `CONTEXT_Forge.md`
3. `docs/handoffs/forge/FORGE_PHASE2_REMAINDER_2026-07-16.md`
4. `docs/handoffs/forge/PHASE2F4_STRUCTURAL_BRIDGE_COMPLETION_2026-07-16.md`
5. `docs/handoffs/forge/README_NEW_SESSION_2026-07-16.md`
