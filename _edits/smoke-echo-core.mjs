...
ok(!!E && E.BUILD==='E5', 'module loads, BUILD E5');
...
ok(/<script src="bardic-echo\.js\?v=E5"><\/script>/.test(html), 'radio.html loads bardic-echo.js, cache-stamped E5');
...
{
  const S = E.summarize;
  ok(E.BUILD==='E5' && typeof E.selfTest==='function', 'BUILD E5 with selfTest exported');
