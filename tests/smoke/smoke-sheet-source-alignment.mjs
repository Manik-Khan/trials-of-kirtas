...
ok('Party imports the full-sheet render shape', party.includes("import { toRenderShape } from './sheet-mount.js?v=src10'"));
...
const projectionImport = party.indexOf("import { toRenderShape } from './sheet-mount.js?v=src10'");
