...
//
// Run: node tests/smoke/smoke-rail.mjs
// ---------------------------------------------------------------------------
...
// ── Scenario B: staff (DM) ──────────────────────────────────────────
{
  ...
  ok(questRpc && /^tok-quest-rich-v1:/.test(questRpc.payload.p_objective), 'B: rail stores Objective through the same safe rich-text envelope');
