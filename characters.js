...
const CHARACTERS = {
  ...
  caim: {
    ...
    skills: [
      { name: 'Acrobatics',      attr: 'DEX', bonus: 0, prof: 'none' },
      { name: 'Animal Handling', attr: 'WIS', bonus: 0, prof: 'none' },
      { name: 'Arcana',          attr: 'INT', bonus: 0, prof: 'none' },
      { name: 'Athletics',       attr: 'STR', bonus: 0, prof: 'none' },
      ...
      { name: 'Perception',      attr: 'WIS', bonus: 0, prof: 'none' },
      ...
      { name: 'Sleight of Hand', attr: 'DEX', bonus: 0, prof: 'none' },
      { name: 'Stealth',         attr: 'DEX', bonus: 0, prof: 'none' },
      { name: 'Survival',        attr: 'WIS', bonus: 0, prof: 'none' },
    ],
    ...
    classFeatures: {
      ...
      martialArtsDie:  'd4',   // scales with level: d4(1-4), d6(5-10), d8(11-16), d10(17-20)
      unarmedDmgDice:  '1d4',
      unarmedHitMod:   0,
    },
    ...
    actions: [
      {
        ...
        type: 'attack',
        hitMod: 0,
        dmgDice: '1d4', critDice: '2d4', dmgMod: 0,
        dmgType: 'Bludgeoning',
      },
    ],

    defaultSlots: ['unarmed', 'empty', 'empty', 'empty'],

    spells: {},

    features: [
      { name: 'Unarmored Defense',   source: 'Monk', desc: 'AC = 10 + DEX mod + WIS mod when unarmored.' },
      { name: 'Martial Arts',        source: 'Monk', desc: 'Use DEX for unarmed strikes. Unarmed damage die increases with level.' },
      { name: 'Ki',                  source: 'Monk', desc: '3 ki points. Flurry of Blows, Patient Defense, Step of the Wind.' },
      { name: 'Hands of Healing',    source: 'Way of Mercy', desc: 'Touch a creature and spend 1 ki to restore 1d6+WIS HP.' },
      { name: 'Hands of Harm',       source: 'Way of Mercy', desc: 'Spend 1 ki after hitting with unarmed strike. Deal extra necrotic damage.' },
      { name: 'Unarmored Movement',  source: 'Monk', desc: 'Speed +10 ft when unarmored.' },
      { name: 'Deflect Missiles',    source: 'Monk', desc: 'Reduce ranged weapon attack damage as a reaction.' },
    ],
