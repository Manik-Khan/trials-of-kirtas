...
node smoke-<name>.mjs               # root-level jsdom / known-answer smokes
```
...
`smoke-placement.js`, `smoke-flora.js`. Root has ~90 `smoke-*.mjs` for the sheet,
gear, shards, rail, and bardic systems.
